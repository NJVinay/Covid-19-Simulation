  ...
  <body>
    <main>
      <header>
        ...
        <section class="meta">
          <div>countries: __COUNTRIES__</div>
          <div>sample_ratio: __SAMPLE_RATIO__</div>
          <div>start_date: __START_DATE__</div>
          <div>end_date: __END_DATE__</div>
        </section>
      </header>
...
"""
    html = (html.replace("__COUNTRIES__", countries_csv)
                .replace("__SAMPLE_RATIO__", f"{DEFAULT_SAMPLE_RATIO:g}")
                .replace("__START_DATE__", DEFAULT_START_DATE)
                .replace("__END_DATE__", DEFAULT_END_DATE))
